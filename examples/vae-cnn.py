...
class VariationalAutoEncoderModelGenerator(ProgColumnGenerator):
    ...
    def generateColumn(self, parentCols, msg = None):
        ...
        b13 = ProgConvTranspose2DBNBlock(128, 63, 3, len(parentCols), activation=nn.LeakyReLU(), layerArgs={'stride': 2, 'padding': 1, 'output_padding': 1})
        b14 = ProgConvTranspose2DBNBlock(63, 32, 3, len(parentCols), activation=nn.LeakyReLU(), layerArgs={'stride': 2, 'padding': 1, 'output_padding': 1})
